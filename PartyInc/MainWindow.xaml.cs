    ...
    public partial class MainWindow : Window
    {
        ...
        private async void Window_Loaded(object sender, RoutedEventArgs e)
		{
			...
			try
			{
				...
				this.AddLine(me, hi);
				this.AddLine(bot, GetResult(await GetAsyncResult(Bot.RespondAsync(botInfo, hi))));

				const string organize = "I want to organize a party";

				this.AddLine(me, organize);
				this.AddLine(bot, GetResult(await GetAsyncResult(Bot.RespondAsync(botInfo, organize))));
                ...
                this.AddLine(bot, GetResult(
                    await GetAsyncResult(Bot.RespondAsync(botInfo, orderCake))));

                const string yesPreferences = "Yes, let's discuss ingredients.";
                this.AddLine(me, yesPreferences);
                this.AddLine(bot, GetResult(
                    await GetAsyncResult(Bot.RespondAsync(botInfo, yesPreferences))));
